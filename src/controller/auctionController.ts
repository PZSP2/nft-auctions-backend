...
export default class AuctionController {
    ...
    getAuctionByAuctionId = async (req: Request, res: Response): Promise<void> => {
    ...
    getAllAuctions = async (req: Request, res: Response): Promise<void> => {
        const auctions = await this.service.getAllAuctions(Number(req.query.nftId) || null, Boolean(req.query.isActive))
