...
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user1@mail.com', 'Eileen_Wallace', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rpnHcdWgSw9tN3cjy9rN33oeasAQUmaquf', 'sEdSiB1PC7Z32ch4z47kSGtrvindjru');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user2@mail.com', 'James_Reed', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rNbtHbSPMbfLCTJWYiPwb63tsDY1K5yPcq', 'sEdVUZNmWKDdsWQz9WYLyp3PGMTLSGC');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user3@mail.com', 'Shannon_Thompson', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rsGMYgYmxRCQAWWXLijLPM6UHEqKjVSY4d', 'sEd7huodvwjJBwMoBK5tQnvqWbDMGPW');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user4@mail.com', 'Barbara_Otten', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rhLw1uHdjwWyKdYGDSYhCunYUs17LmMrtW', 'sEdTtTj4ZithtccPwRn3zsdrqq76cmF');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user5@mail.com', 'Joaquin_Leib', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rU9iTnNY8iAJ7h69htSSA4fj79YtCQa5a7', 'sEdVdHAmE384uMGYHrieTVu7Txvxh3w');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user6@mail.com', 'Jack_Haggerty', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rDnQHRTWaXjE5vZgFfG87GjK2YfE7qyUoK', 'sEdVpjcsy8QeEks3QnCL8yFPrfiYoXM');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user7@mail.com', 'Frances_Johnson', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rK5sJFT7UJJFCcqN7SYoVKUiNZx6Ce7STd', 'sEdTrwTDCUocxSPu26LT5p1xiWdPwx6');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user8@mail.com', 'Verla_Sexton', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rULBD2PQSLeu71M2rmoJMdu7gKvZCRJRY4', 'sEdV3SfmHBnDWLewmf9ybjW16pTM5tU');
INSERT INTO "User" (email, name, "accountType", password, wallet_address, wallet_seed)  VALUES ('user9@mail.com', 'Karen_Degeorge', 'NORMAL_USER', '$2a$10$TcrdvBfXmrD7m8H.UM4K0.nIOcq3IhSdwNMjJFOPsjzkD.a2xJOzS', 'rh71hVodnunH8nFJmJWLx3XbHb7TALcGVL', 'sEdSQuqeWrewF9zFH8nkwAAxy1VwK7V');
